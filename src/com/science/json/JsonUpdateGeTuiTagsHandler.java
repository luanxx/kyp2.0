...
public class JsonUpdateGeTuiTagsHandler {
	...
	public JsonUpdateGeTuiTagsHandler(String str)
	{
		json=str;
		map=new HashMap<String, String>();
	}
	
	public JsonUpdateGeTuiTagsHandler()
	{
		map=new HashMap<String, String>();
	}
	...
	public Map<String, String> getListItems(InputStream input)
	{
		...
		try {
	        ...
	        if (codeString.equals("200")) {
		        ...
		        JSONArray array = tempJsonObject.getJSONArray("pushtags.list");
		        for (int i = 0; i < array.length(); ++i) {
		        	JSONObject temp = (JSONObject) array.opt(i);
		        	map.put("pushtags", temp.getString("pushtags"));
		        }
		        return map;
			}
	        else
